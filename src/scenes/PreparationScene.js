...
class PreparationScene extends Scene {
    ...
    start () {
        ...
        const simpleBytton = document.querySelector('[data-computer="simple"]'); 
        const middleBytton = document.querySelector('[data-computer="middle"]');
        const hardBytton = document.querySelector('[data-computer="hard"]');       
        ...
        this.removeEventListeners.push(addEventListener(simpleBytton, 'click', () => this.startComputer('simple')));
        this.removeEventListeners.push(addEventListener(middleBytton, 'click', () => this.startComputer('middle')));
        this.removeEventListeners.push(addEventListener(hardBytton, 'click', () => this.startComputer('hard')));
        }
    stop () {
